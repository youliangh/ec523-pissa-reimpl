...
def generate_sample(model, tokenizer: transformers.PreTrainedTokenizer, prompts, max_new_tokens=256):
    current_device = torch.cuda.current_device()
    input_ids = tokenizer(prompts, padding=True, return_tensors="pt").to(current_device)
